...
public class NpcTests
{
    ...
    public async Task Fallout4Npc_ActorEffectsSortCorrectlyThroughSerialization(
    ...
    [Theory, MutagenModAutoData(GameRelease.Fallout4)]
    public async Task Fallout4Npc_FactionsSortCorrectlyThroughSerialization(
        IFileSystem fileSystem,
        DirectoryPath existingTempDir,
        Fallout4EntryPoint entryPoint,
        Fallout4Mod mod)
    ...
    [Theory, MutagenModAutoData(GameRelease.Fallout4)]
    public async Task Fallout4Npc_ItemsSortCorrectlyThroughSerialization(
        IFileSystem fileSystem,
        DirectoryPath existingTempDir,
        Fallout4EntryPoint entryPoint,
        Fallout4Mod mod)
    ...
    // [Theory, MutagenModAutoData(GameRelease.Fallout4)]
    // public async Task Fallout4Npc_AttacksSortCorrectlyThroughSerialization(
    //     IFileSystem fileSystem,
    //     DirectoryPath existingTempDir,
    //     Fallout4EntryPoint entryPoint,
    //     Fallout4Mod mod)
