...
public class ImpactDataSetTests
{
    ...
    public async Task SkyrimImpactDataSet_SortsCorrectlyThroughSerialization(
        ...
        SkyrimMod mod)
    {
        ...
        impactDataSet.Impacts.Add(new Mutagen.Bethesda.Skyrim.ImpactData()
        {
            Material = new FormKey(mod.ModKey, 0x789).ToLink<Mutagen.Bethesda.Skyrim.IMaterialTypeGetter>(),
            Impact = new FormKey(mod.ModKey, 0x456).ToLink<Mutagen.Bethesda.Skyrim.IImpactGetter>()
        });
        impactDataSet.Impacts.Add(new Mutagen.Bethesda.Skyrim.ImpactData()
        {
            Material = new FormKey(mod.ModKey, 0x123).ToLink<Mutagen.Bethesda.Skyrim.IMaterialTypeGetter>(),
            Impact = new FormKey(mod.ModKey, 0xABC).ToLink<Mutagen.Bethesda.Skyrim.IImpactGetter>()
        });
        impactDataSet.Impacts.Add(new Mutagen.Bethesda.Skyrim.ImpactData()
        {
            Material = new FormKey(mod.ModKey, 0x456).ToLink<Mutagen.Bethesda.Skyrim.IMaterialTypeGetter>(),
            Impact = new FormKey(mod.ModKey, 0x123).ToLink<Mutagen.Bethesda.Skyrim.IImpactGetter>()
        });
    ...
    [Theory, MutagenModAutoData(GameRelease.SkyrimSE)]
    public async Task SkyrimImpactDataSet_SortsByMaterialThenImpact_ThroughSerialization(
        IFileSystem fileSystem,
        DirectoryPath existingTempDir,
        SkyrimEntryPoint entryPoint,
        SkyrimMod mod)
    {
        ...
        {
            Material = new FormKey(mod.ModKey, 0x456).ToLink<Mutagen.Bethesda.Skyrim.IMaterialTypeGetter>(),
            Impact = new FormKey(mod.ModKey, 0x999).ToLink<Mutagen.Bethesda.Skyrim.IImpactGetter>()
        });
        impactDataSet.Impacts.Add(new Mutagen.Bethesda.Skyrim.ImpactData()
        {
            Material = new FormKey(mod.ModKey, 0x123).ToLink<Mutagen.Bethesda.Skyrim.IMaterialTypeGetter>(),
            Impact = new FormKey(mod.ModKey, 0x789).ToLink<Mutagen.Bethesda.Skyrim.IImpactGetter>()
        });
        impactDataSet.Impacts.Add(new Mutagen.Bethesda.Skyrim.ImpactData()
        {
            Material = new FormKey(mod.ModKey, 0x123).ToLink<Mutagen.Bethesda.Skyrim.IMaterialTypeGetter>(),
    ...
    [Theory, MutagenModAutoData(GameRelease.SkyrimSE)]
    public async Task SkyrimImpactDataSet_NullImpacts_HandledCorrectlyThroughSerialization(
        IFileSystem fileSystem,
        DirectoryPath existingTempDir,
        SkyrimEntryPoint entryPoint,
        SkyrimMod mod)
    ...
    [Theory, MutagenModAutoData(GameRelease.SkyrimSE)]
    public async Task SkyrimImpactDataSet_SingleImpact_NoSortingNeededThroughSerialization(
        IFileSystem fileSystem,
        DirectoryPath existingTempDir,
        SkyrimEntryPoint entryPoint,
        SkyrimMod mod)
